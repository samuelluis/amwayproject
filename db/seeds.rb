...
Member.create(:code => "001", :points => 300, :person => Person.new(:name => "Samuel", :last_name => "Luis De La Cruz"), :user => User.new(:email => "leandro@amway.com", :password => "password"), :parent_id => 1)
Member.create(:code => "002", :points => 300, :person => Person.new(:name => "Jinette", :last_name => "Lizardo"), :user => User.new(:email => "leandro@amway.com", :password => "password"), :parent_id => 1)
Member.create(:code => "003", :points => 300, :person => Person.new(:name => "Wagnel", :last_name => "Cuello"), :user => User.new(:email => "leandro@amway.com", :password => "password"), :parent_id => 1)
